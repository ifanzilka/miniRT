...
/*   Updated: 2021/02/03 15:33:32 by bmarilli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static void	ft_add_color_li(t_cp_l *cp_l, t_xyz *n, t_light *li)
// {
// 	if (cp_l->n_dot_l > 0.1)
// 	{
...
// static void	ft_add_color_li_sp(t_cp_l *cp_l, t_xyz *v, t_light *li, t_xyz *n, int *sp)
// {
// 	if (*sp > 1)
// 	{
...
// 					(ft_len_vect(cp_l->r) * ft_len_vect(*v)), *sp);
// 			cp_l->color_pix = ft_rgb_plus_rgb(cp_l->color_pix,
// 					ft_rgb_mult_db(li->rgb, cp_l->i));
// 		}
// 	}
